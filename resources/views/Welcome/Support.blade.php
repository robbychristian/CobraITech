...
@section('content')
    ...
    <div class="row d-flex justify-content-around align-items-center">
        <div class="col-xs-12 col-md-8 d-flex flex-column align-items-center justify-content-center">
            <form id="applicationForm" action="{{ route('welcome.query') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nameSupport" name="name">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Email address <span
                            class="text-danger">*</span></label>
                    <input type="email" class="form-control" id="emailSupport" aria-describedby="emailHelp" name="email">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Message <span
                            class="text-danger">*</span></label>
                    <textarea class="form-control" id="messageSupport" aria-describedby="emailHelp" rows="5" name="message"></textarea>
