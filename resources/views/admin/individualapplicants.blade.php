...
@section('content')
    @foreach ($applicantDetails as $details)
        <div class="container my-2 ">
            <div class="card p-5">
                ...
                <div class="fs-6 mt-5">I am {{ $details->name }} and I am applying as a {{ $details->job_category }}
                    in your company. {{ $details->message }}
                </div>
                <div class="fs-6 mt-5">Attached below is my curriculum vitae for you reference to my skills and
                    experience. Thank you for taking time and consideration in reviewing my application!</div>
                <div class="fs-6 mt-5">Sincerely,</div>
                <div class="fs-6">{{ $details->name }}</div>
            </div>
            <iframe src="{{ asset('storage/applications/' . $details->email . '/' . $details->curriculum_vitae) }}"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.replyTo') }}" id="replytoform" method="POST">
                            @csrf
                            @method('POST')
                            ...
                            <div class="row g-3 justify-content-center my-2">
                                ...
                                <div class="col-9">
                                    ...
                                    <input type="text" id="inputPassword6" name="name" value="{{ $details->name }}"
                                        readonly class="form-control d-none" aria-describedby="passwordHelpInline">
                                </div>
                            </div>
                            <div class="row g-3 justify-content-center my-2">
                                <div class="col-2">
